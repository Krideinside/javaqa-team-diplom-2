...
public class SavingAccount extends Account {
    ...
    public void setMinBalance(int minBalance) {
        ...
        if (minBalance < 0) {
            throw new IllegalArgumentException(
                    "Минимальный баланс не может быть меньше нуля, а у вас он " + minBalance
            );
        }
        ...
        if (minBalance > balance) {
            throw new IllegalArgumentException(
                    "Минимальный баланс не может быть больше текущего"
            );
        }
        this.minBalance = minBalance;
    }
    ...
    public void setMaxBalance(int maxBalance) {
        ...
        if (maxBalance < 0) {
            throw new IllegalArgumentException(
                    "Максимальный баланс не может быть меньше нуля, а у вас он " + maxBalance
            );
        }
        if (maxBalance < minBalance) {
            throw new IllegalArgumentException(
        ...
        if (maxBalance < balance) {
            throw new IllegalArgumentException(
                    "Максимальный баланс не может быть меньше текущего"
            );
        }
        this.maxBalance = maxBalance;
    }
